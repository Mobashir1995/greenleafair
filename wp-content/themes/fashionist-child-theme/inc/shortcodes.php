...
/*?>
	<div class="fashion-best-sellers-container">
		<div class="fashion-best-sellers">
			<?php if( !empty( $product_categories ) ){ foreach( $product_categories as $category ){ ?>
				<div class="fashion-best-item">
					<?php
						$cat_thumb_id = get_woocommerce_term_meta( $category->term_id, 'thumbnail_id', true );
					?>
					<div class="fashion-best-item-inn" style="background-image: url(<?php echo wp_get_attachment_image_url($cat_thumb_id, 'large'); ?>);">
						<div class="fashion-best-item-desc">
							<h3><a href="<?php echo get_term_link( $category->term_id, 'product_cat' ); ?>"><?php echo trim($category->name); ?></a></h3>
							<?php //echo trim($category->description); ?>
							<!-- <div class="read-more-btn-container">
								<a class="read-more-btn" href="<?php echo get_term_link( $category->term_id, 'product_cat' ); ?>">Read More</a>
							</div> -->
						</div>
					</div>
				</div>
...
?>
	<div class="fashion_services_lists">
		<?php if( !empty( $product_categories ) ){ foreach( $product_categories as $category ){ $cat_thumb_id = get_woocommerce_term_meta( $category->term_id, 'thumbnail_id', true ); ?>
	      ...
	      <div class="wh-padding fashion-blog-item">
	         <div class="img-container">
	            ...
	            <a href="<?php the_permalink(); ?>">
	            	<?php if( has_post_thumbnail() ){ the_post_thumbnail('large'); }else{ echo '<img src="https://via.placeholder.com/400">'; }?>
	            </a>
	         </div>
	         <div class="data">
	            <h3>
		...
		<div class="fashion-clients-reviews">
	      ...
	      <div class="fashion-client-review">
	         <!-- <div class="fashion-client-img">
	            <?php if( has_post_thumbnail() ){ the_post_thumbnail('large'); }else{ echo '<img src="https://via.placeholder.com/100">'; }?>
	         </div> -->
