			...
			<?php } ?>
				<div class="product-img">
					...
					<div class="actions">
						...
						<?php } else { ?>
							<a <?= $button_satus; ?> rel="nofollow" href="/?add-to-cart=<?php echo intval($product->get_id()); ?>" data-quantity="1" data-product_id="<?php echo intval($product->get_id()); ?>" data-product_sku="" class="action add_to_cart_button ajax_add_to_cart added <?= $button_satus; ?>"><span class="icon-shoppingcart"></span></a>
						<?php } ?>
